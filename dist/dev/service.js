...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! alpheios-messaging */ "./node_modules/alpheios-messaging/index.js");
...
const messageHandler = (request, responseFn) => {
  if (!cedictData.isReady) {
    responseFn(alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["ResponseMessage"].Error(request, new Error('Uninitialized')))
    return
  }
  ...
  if (request.body.getWords) {
    ...
    cedictData.getWords(request.body.getWords.words, request.body.getWords.characterForm)
      ...
      }).catch((error) => responseFn(alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["ResponseMessage"].Error(request, error)))
  } else {
    responseFn(alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["ResponseMessage"].Error(request, new Error('Unsupported request')))
  }
}

document.addEventListener('DOMContentLoaded', () => {
  const service = new alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["MessagingService"](messagingServiceName, new alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["WindowIframeDestination"](alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["CedictDestinationConfig"]))
  service.registerReceiverCallback(alpheios_messaging__WEBPACK_IMPORTED_MODULE_0__["CedictDestinationConfig"].name, messageHandler)
